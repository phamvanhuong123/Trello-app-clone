...
export const mockData = {
    board: {
      _id: 'board-id-01',
      title: 'UntPham MERN Stack Board',
      ...
      columns: [
        {
          ...
          cardOrderIds: ['card-id-02', 'card-id-01', 'card-id-07', 'card-id-04', 'card-id-05', 'card-id-06', 'card-id-03'],
          cards: [
            {
              _id: 'card-id-01',
              boardId: 'board-id-01',
              ...
              cover: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc9APxkj0xClmrU3PpMZglHQkx446nQPG6lA&',
        ...
        },
        {
          ...
          cardOrderIds: ['card-id-08', 'card-id-10', 'card-id-9'],
          cards: [
        ...
        },
        {
          ...
          cardOrderIds: ['card-id-12', 'card-id-11', 'card-id-13'],
          cards: [
